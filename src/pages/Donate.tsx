...
export function Donate() {
  return (
    <div className="bg-brand-light min-h-screen">
      <SEO 
        title="Donate & Support OMCS"
        description="Help Ottawa Muslim Community Services provide mental health, food assistance, and crucial community programs. Make a donation today."
        canonicalUrl="/donate"
      />
      {/* Hero Section */}
