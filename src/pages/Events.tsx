...
export function Events() {
  ...
  return (
    <div className="bg-brand-light">
      <SEO 
        title="Upcoming Events & Workshops - OMCS"
        description="Discover upcoming community gatherings, wellness workshops, and youth programs hosted by Ottawa Muslim Community Services."
        canonicalUrl="/events"
      />
      <PageHeader 
        title="Events" 
